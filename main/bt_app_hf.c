    ...
    switch (event) {
        ...
        case ESP_HF_CLIENT_AUDIO_STATE_EVT:
        {
            ...
            if (param->audio_stat.state == ESP_HF_CLIENT_AUDIO_STATE_CONNECTED ||
                ...
                ESP_LOGI(BT_HF_TAG, "registering data callback");
                esp_hf_client_register_data_callback(bt_app_hf_client_tx_data_cb, read_ringbuf); // write_ringbuf, read_ringbuf
                ...
                bt_i2s_hfp_task_shut_down();
                ESP_LOGI(BT_HF_TAG, "--ESP HF Audio Connection Disconnected.");
            }
            break;
        }
